...
def pad_sents(sents, pad_token):
    ...
    logest_len=max(lengths)
    to_be_filled=[longest_len-length for length in lengths]
    sents_padded = [[pad_token]*(num//2)+sent+[pad_token]*(num-num//2) for num,sent in zip(to_be_filled,sents)]
